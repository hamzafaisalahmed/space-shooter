...
\begin{table}[htbp]
    ...
    \begin{tabular}{|c|l|p{7.5cm}|}
        ...
        \hline
        1 & \texttt{EnemyType.h}       & Enemy stat profile class + 3 concrete subclasses + \texttt{EnemyTypeRegistry} \\
        \hline
...
\begin{table}[htbp]
    ...
    \begin{tabular}{|l|p{9cm}|}
        ...
        \hline
        Composition & \texttt{Game} owns \texttt{Player}, \texttt{ObjectPool<Bullet>}, \texttt{ObjectPool<Enemy>}, \texttt{ObjectPool<Particle>}, and \texttt{Level*[]} as member variables (has-a relationships) \\
        \hline
